/*
 * Matt Krikorian
This class updates knowledge regarding the location of the Wumpus
If the agent smells a stench, it knows the Wumpus is in 1 of the 
4 surrounding squares, and is not anywhere else
 */
